...
echo -e "${YELLOW}🌐 Installing Python Watchdog dependencies...${NC}"
sudo pip3 install requests psutil --break-system-packages || true

echo -e "${YELLOW}🔥 Configuring PPS Limits for Monad RaptorCast...${NC}"
...
echo -e "${GREEN}✅ System dependencies completed!${NC}"
